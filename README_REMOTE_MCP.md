...
- **ECS Fargate + ALB:** `./scripts/deploy_ecs.sh` — builds **`Dockerfile.ecs`**, pushes ECR, deploys [infra/ecs/template.yaml](infra/ecs/template.yaml). Guide: [infra/DEPLOY.md](infra/DEPLOY.md#aws-ecs-fargate--alb).
