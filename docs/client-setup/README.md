...
**Quick routing:** organizational policy/playbooks or OvalEdge UI/features → `knowledge_search`; physical datasets → `asset_explorer`; native Redshift/Snowflake/Tableau grants → `source_system_access`.
