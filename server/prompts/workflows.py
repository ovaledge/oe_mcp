...
def register(mcp: FastMCP) -> None:
    ...
    def data_discovery(query: str) -> list[Message]:
        ...
        text = (
            ...
            f"2. Call {TOOL_SEARCH_CATALOG} with search_term from those keywords "
    ...
    def explain_business_term(term: str) -> list[Message]:
        ...
        text = (
            ...
            f"with object_id and object_type (oetable or oefile) from the payload\n"
    ...
    def trust_assessment(asset_name: str) -> list[Message]:
        ...
        text = (
            ...
            f"Steps:\n"
            f"1. Call {TOOL_SEARCH_CATALOG} with search_term '{asset_name}' to resolve object_id "
            f"and object_type (prefer oetable or oefile)\n"
    ...
    def explore_data_domain(domain: str) -> list[Message]:
        ...
        text = (
            ...
            f"Steps:\n"
            f"1. Call {TOOL_SEARCH_CATALOG} with search_term '{domain}' and "
            f"object_type=glossary for key terms; also try term-specific "
            f"{TOOL_LOOKUP_GLOSSARY_TERM} when names are known\n"
            f"2. Call {TOOL_SEARCH_CATALOG} with domain keywords and "
