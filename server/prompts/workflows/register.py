...
def register(mcp: FastMCP) -> None:
    ...
    def native_source_access(
        ...
        text = (
            ...
            f"({MCP_SOURCE_SYSTEMS_DOC}) and query_direction from step 1. Only those two fields "
            f"are mandatory; path routing and optional parameters (username, object_path, "
            f"object_type, connection_id, privileges, etc.): see "
            f"docs://ovaledge/rdam_source_access and docs://ovaledge/mcp_workflows "
            f"(Native source access — object_path formats "
            f"and DAM browse).\n"
