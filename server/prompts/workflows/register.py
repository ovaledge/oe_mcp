...
def register(mcp: FastMCP) -> None:
    ...
    def native_source_access(
        ...
        text = (
            ...
            f"supplies them. Named objects without connection_id (e.g. SUPERSTORE.SUPERSTORE) "
            f"are resolved via {TOOL_ASSET_EXPLORER} inside {TOOL_ACCESS_EXPLORER}, then always "
            f"the DAM API — pass object_path or fully_qualified_name and omit connection_id. "
            f"Always set "
