...
_DESC_SEARCH = (
    ...
    + MCP_CATALOG_OBJECT_TYPES_DOC
    + " — or omit for all types. JDBC-backed exclusive searches (use alone, not combined):\n"
    "- `dp_domain` — Data Domains\n"
    "- `dp_product` — Data Products (includes unpublished)\n"
    "- `oeglobaldomain` — glossary Global Domains\n"
    "- `storyzone` — Data Story Zones\n\n"
