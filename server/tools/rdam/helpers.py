...
_DESC_USER_OBJECT_ACCESS = (
    ...
    "**summary** (server-computed): `totalGrants`, `byObjectLevel`, `byGrantMechanism`.\n\n"
    "Partial-path disambiguation: **matchCandidates** or **resolve_all_matches=true** (max 50).\n"
    "Tableau: project (`rdam_reportgroup_privilege`) and report (`rdam_report_privilege`); "
    "use `/` for reports (e.g. `Executive/Revenue Dashboard`).\n\n"
